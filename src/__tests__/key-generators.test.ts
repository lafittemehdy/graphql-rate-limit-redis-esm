...
describe("Key Generators", () => {
  ...
  describe("createDefaultKeyGenerator", () => {
    ...
    it("should reject non-object options in JavaScript usage", () => {
      expect(() =>
        createDefaultKeyGenerator("invalid-options" as unknown as never),
  ...
  describe("createUserKeyGenerator", () => {
    it("should reject invalid callback input", () => {
      expect(() =>
        createUserKeyGenerator("invalid" as unknown as never),
      ).toThrow("getUserId must be a function");
    });
  ...
  describe("createCompositeKeyGenerator", () => {
    it("should reject invalid callback input", () => {
      expect(() =>
        createCompositeKeyGenerator("invalid" as unknown as never),
      ).toThrow("getIdentifiers must be a function");
    });
  ...
  describe("Edge Cases", () => {
    it("should truncate key parts exceeding 256 characters", () => {
      ...
      const keyGenerator = createUserKeyGenerator<UserContext>(
